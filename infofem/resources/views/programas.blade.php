    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="active" href="{{route('instituciones.index')}}">Instituciones</a></li>
        </ul>
  ...
  <main id="main">
    ...
    <section id="breadcrumbs" class="breadcrumbs">
      <div class="container">
        ...
        <ol>
          <li><a href="{{route('home')}}">Incicio</a></li>
        ...
        <table class="table-primary">
          ...
          <tbody>
           <?php $cont = 0;?>
            ...
            <tr>
              <?php $cont++;?>
            <td class="table-primary">{{$cont}}.- {{$programa['nombre']}}</td>
          </tr>
          @endforeach
          </tbody>
        </table>
        @else
          <h1>No tenemos registro de programas de esta institución</h1>
          @endif
      </div>
      </div>
